...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>DarwinMuseum Login</title>
	...
	<body>
		<header id="header">
			<div class="logo">
				<div>
					<h1><a href="homepage" id="logo">Darwinmuusem</a></h1>
		...
		<nav id="nav" class="skel-panels-fixed">
			<ul>
				<li class='current_page_item'><a href='login'>Login</a></li>
						...
						<div class="content content-right">
							...
							<article class="is-page-content">
								...
								<section>
									...
									<?php echo form_open('verify_inlog_gebruiker'); ?>
										<label for="email">E-mailadres:</label>
										<input type="text" size="20" id="emailadres" name="email"/>
                                                                                <br/>
										<input type="submit" value="inloggengebruiker"/>
									</form>
								</section>
							</article>
