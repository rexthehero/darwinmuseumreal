...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<?php echo form_open('verifyregisterverkoper'); ?>
			...
			<label for="gebruikersrol"></label>  
                        <input type="hidden" value="verkoper" name="gebruikersrol"/>
                      
                            <label for="geblokkeerd">geblokkeerd:</label>
                        <input type="hidden" value="0" name="geblokkeerd"/>
