...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>collectie 1ste verdieping</title>
	...
	<body>
		<header id="header">
			<div class="logo">
				<div>
					...
					<span class="byline">Collectie</span>
				</div>
			</div>
		</header>
		...
		<nav id="nav" class="skel-panels-fixed">
			<ul>
				<li class='current_page_item'><a href='eerstediep'>1ste verdieping</a></li>
				<?php echo $links; ?>
			</ul>
		</nav>
					...
					<div class="9u skel-cell-mainContent">
						<div class="content content-right">
							...
							<article class="is-page-content">
								<header>
									<h2>Collectie 1ste verdieping</h2>
